...
def load_fp8_checkpoint(checkpoint_path, device='cpu', dtype_override=None):
    """
    ...
    if dtype_override is not None:
        ...
        for key, tensor in raw_state_dict.items():
            ...
            if original_dtype in ['F8_E4M3', 'F8_E5M2']:
                # This was an FP8 tensor, convert carefully
                if dtype_override == torch.float8_e4m3fn and hasattr(torch, 'float8_e4m3fn'):
                    # Keep as FP8 if requested and supported
